...
CATALINA_OPTS="-Xms${JVM_MINIMUM_MEMORY:=_CONFLUENCE_MIN_MEM_} -Xmx${JVM_MAXIMUM_MEMORY:=_CONFLUENCE_MAX_MEM_} -Dconfluence.home=${CONFLUENCE_HOME} -XX:+UseG1GC ${CATALINA_OPTS}"
